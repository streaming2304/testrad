                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="cagetory">Cagetory <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-cagetory"  value="<?php  echo $this->set_field_value('cagetory',''); ?>" type="text" placeholder="Enter Cagetory"  required="" name="cagetory"  class="form-control " />
